<%@ Page Title="" Language="C#" MasterPageFile="~/FrontSite.Master" AutoEventWireup="true" CodeBehind="contract.aspx.cs" Inherits="DinersRealEstateManagement.contract" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!-- Contract-->
    <div id="portfolio">
        <div class="container px-4 pt-5 px-lg-5">
            <div class="row gx-4 gx-lg-5">
                <div class="col-lg-12" id="signup" runat="server" visible="False" >
                    <pre class="rounded mx-auto d-block mb-2" style="min-height: 600px;max-height: 600px;"><b>大來不動產資料管理系統會員條款</b>
...
(二) 對於本服務條款之解釋與適用產生疑義雙方同意依中華民國之法律、行政解釋、習慣及法理原則予以處理。
                ...
                <div class="col-lg-12" id="serves" runat="server" visible="False">
                    <pre class="rounded mx-auto d-block mb-2" style="min-height: 600px;max-height: 600px;"><b>大來不動產資料管理系統會員服務契約</b>
...
因本契約涉及的一切爭訟，雙方合意以甲方總公司所在地之地方法院為第一審管轄法院，但不得排除消費者保護法第四十七條或民事訴訟法第四百三十六條之九規定小額訴訟管轄法院之適用。
                ...
                <div class="col-lg-12" id="personal" runat="server" visible="False">
                    <pre class="rounded mx-auto d-block mb-2" style="min-height: 600px;max-height: 600px;"><b>大來不動產資料管理系統個人資料保護與隱私權政策</b>
